...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.instructionEdit.setGeometry(QtCore.QRect(1, 31, 310, 220))
        ...
        self.editButton.setGeometry(QtCore.QRect(311, 31, 88, 110))
        self.editButton.setAutoDefault(False)
        self.editButton.setObjectName("editButton")
        self.okButton = QtWidgets.QPushButton(Dialog)
        self.okButton.setGeometry(QtCore.QRect(311, 141, 88, 110))
        self.okButton.setAutoDefault(False)
        self.okButton.setObjectName("okButton")
        self.barcodeView = QtWidgets.QLabel(Dialog)
        self.barcodeView.setGeometry(QtCore.QRect(0, 251, 400, 177))
