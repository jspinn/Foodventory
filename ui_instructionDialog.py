...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.instructionEdit.setGeometry(QtCore.QRect(1, 31, 311, 270))
        ...
        self.editButton.setGeometry(QtCore.QRect(312, 31, 88, 135))
        self.editButton.setAutoDefault(False)
        self.editButton.setObjectName("editButton")
        self.okButton = QtWidgets.QPushButton(Dialog)
        self.okButton.setGeometry(QtCore.QRect(312, 167, 88, 135))
        self.okButton.setAutoDefault(False)
        self.okButton.setObjectName("okButton")
        self.barcodeView = QtWidgets.QLabel(Dialog)
        self.barcodeView.setGeometry(QtCore.QRect(0, 303, 400, 177))
        ...
        self.nameLabel.setGeometry(QtCore.QRect(10, 0, 291, 31))
